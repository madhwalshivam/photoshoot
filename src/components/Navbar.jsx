...
export default function Header() {
  ...
  const sets = [
    ...
    { name: 'Spanish Cafe', href: '/spanish-cafe-photoshoot-location-in-delhi' },
    ...
    { name: 'Junkyard', href: '/junkyard-photoshoot-location-in-delhi' },
    ...
    { name: 'Brick Wall', href: '/brick-wall-photoshoot-location-in-delhi' },
    { name: 'Pillar Set', href: '/pillar-set-photoshoot-location-in-delhi' },
    ...
    { name: 'Red Open Car', href: '/red-open-car-photoshoot-location-in-delhi' },
