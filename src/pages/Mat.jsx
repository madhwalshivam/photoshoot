...
const Mat = () => {
  ...
  <p className="text-2xl md:text-4xl font-bold mb-4 font-playfair text-black">
    Celebrating the Journey of Motherhood<br />
    <span className="text-pink-500">with Timeless Memories</span>
  </p>

  <p className="text-base md:text-lg text-gray-700 max-w-3xl mx-auto mb-10">
    At <span className="font-semibold text-black">The Picture Town</span>, we specialize in crafting 
    heartfelt maternity photoshoots that honor your beautiful journey into motherhood. 
