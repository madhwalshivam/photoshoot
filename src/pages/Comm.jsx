...
import a1 from "../assets/co1.png";
import a2 from "../assets/co2.jpg";
import a3 from "../assets/co3.jpg";
import a4 from "../assets/co4.jpg";
import a5 from "../assets/co5.jpg";
import a6 from "../assets/co6.jpg";
import a7 from "../assets/co7.jpg";
import a8 from "../assets/co8.jpg";
import a9 from "../assets/co9.jpg";
import a10 from "../assets/co10.jpg";
import a11 from "../assets/co11.jpg";
import a12 from "../assets/co12.jpg";
...
const Comm = () => {
  ...
  <meta 
    property="og:url" 
    content="https://thepicturetown.com/commercial-shoot-in-delhi" 
  />
</Helmet>
  ...
  <p className="text-2xl md:text-4xl font-bold mb-4 font-playfair text-black">
    <span className="font-playfair">Professional Commercial Shoots</span>
    <br />
    <span className="text-orange-500">That Elevate Your Brand</span>
  </p>
  ...
  <p className="text-base md:text-lg text-gray-700 max-w-3xl mx-auto mb-10">
    ...
    advertising and promotional content, our professional photography captures
    every detail with precision and creativity. Recognized among the{" "}
    <span className="font-semibold text-black">
      best commercial shoot location in Delhi NCR
    </span>
    , we combine industry expertise with artistic vision to deliver high-quality
    images that resonate with your audience and drive engagement.
  </p>
</div>
